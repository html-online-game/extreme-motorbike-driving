function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Extreme_Motorbike.loader.js";
		var config = {
        dataUrl: buildUrl + "/Extreme_Motorbike.data",
        frameworkUrl: buildUrl + "/Extreme_Motorbike.framework.js",
        codeUrl: buildUrl + "/Extreme_Motorbike.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Extreme Motorbike",
        productVersion: "1.0",
      };
